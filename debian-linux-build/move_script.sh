...
rsync -rvcz --chown=user:user --chmod=755 /home/user/stemnet/daily_files /home/user/stemnet/data_out/
rsync -rvcz --chown=user:user --chmod=755 /home/user/stemnet/logfiles /home/user/stemnet/data_out/  
rsync -rvcz --chown=user:user --chmod=755 /home/user/stemnet/climatology_files /home/user/stemnet/data_out/
